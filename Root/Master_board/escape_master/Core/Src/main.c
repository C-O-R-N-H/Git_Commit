...
uint16_t vertical_PWM;
uint16_t horizontal_PWM;
...
int16_t roll_rate;
int16_t yaw_arr[100];
int16_t pitch_arr[100];
int16_t roll_arr[100];
int roll_avg_index = 0;
int roll_avg_sum_yaw = 0;
int roll_avg_sum_pitch = 0;
int roll_avg_sum_roll = 0;
int roll_avg_yaw = 0;
int roll_avg_pitch = 0;
int roll_avg_roll = 0;
