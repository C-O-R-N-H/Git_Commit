...
void HAL_TSC_MspDeInit(TSC_HandleTypeDef* htsc)
{
  ...
  /* USER CODE END TSC_MspDeInit 0 */
    ...
    PB6     ------> TSC_G5_IO3
    */
    HAL_GPIO_DeInit(GPIOA, GROUP1_SAMPLE_Pin|GROUP1_CHANNEL_Pin|GROUP2_CHANNEL_Pin|GROUP2_SAMPLE_Pin
                          |GROUP4_CHANNEL_Pin|GROUP4_SAMPLE_Pin);

    HAL_GPIO_DeInit(GPIOB, GROUP3_SAMPLE_Pin|GROUP3_CHANNEL_Pin|GROUP6_CHANNEL_Pin|GROUP6_SAMPLE_Pin
                          |GROUP5_SAMPLE_Pin|GROUP5_CHANNEL_Pin);
